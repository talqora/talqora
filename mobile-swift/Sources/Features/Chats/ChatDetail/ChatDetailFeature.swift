...
@Reducer
public struct ChatDetailFeature: Sendable {
    public init() {}
    ...
    public struct State: Equatable {
        public init(
            ...
            self.draft = draft
            self.showFunctionPanel = showFunctionPanel
        }
    ...
    public enum Action: BindableAction {
        ...
        public enum Alert: Equatable { case retryLoad }
        public enum CallChoice: Equatable { case voice, video }
